...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wextra', '-O0', '-ggdb', '-g3', '-Wall', '-Wextra', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CXX = ['/usr/bin/g++']
CXXDEFINES = ['_DEBUG']
CXXFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wextra', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['error-model', 'udp-client-server', 'tcp', 'tutorial', 'energy', 'stats', 'udp', 'realtime', 'routing', 'naming', 'socket', 'ipv6', 'wireless', 'matrix-topology']
...
NS3_EXECUTABLE_PATH = ['/home/yiran/DCQCN-TCD/build/src/emu', '/home/yiran/DCQCN-TCD/build/src/fd-net-device', '/home/yiran/DCQCN-TCD/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.8.5', '/home/yiran/DCQCN-TCD/build']
...
cfg_files = ['/home/yiran/DCQCN-TCD/build/ns3/config-store-config.h', '/home/yiran/DCQCN-TCD/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
