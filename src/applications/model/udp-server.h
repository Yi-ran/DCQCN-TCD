...
public:
  ...
  typedef Callback<void, Ptr<Socket> > QpCompleteCallback;
  QpCompleteCallback m_qpCompleteCallback;

  TracedCallback<Ptr<Socket>,uint32_t,Time> m_traceQpComplete;
